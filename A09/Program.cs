...
namespace A09 {
    class Program {
        ...
        public static void LoadQuestionsFromJson() {
            ...
            // Parse JSON-File into a List of a suitable class
            ...
            // Add those Quizelements to the Quizool
        ...
        public static Boolean FollowUserInstruction() {
            ...
            switch (Console.ReadLine().ToUpper()) {
                ...
                case "E":
                    ...
                    return false;
                default:
                    if (currentQuizelement < quizPool.Count) {
                        SolveAQuestion(quizPool[currentQuizelement]);
                        return true;
                    } else {
                        Console.Clear();
